...
class GameTestCase(unittest.TestCase):
    ...
    def test_act_on_users_move_game_won(self):
        self.game = Game([[1, 2, 3, 4],
                          ...
                          [9, 10, 11, ""],
                          [13, 14, 15, 12]])
        self.assertTrue(self.game.act_on_users_move(UsersMove.LEGAL_MOVE, "\x1b[A"))
    ...
    def test_act_on_users_move_game_not_won(self):
        self.game = Game([[1, 2, 3, 4],
                          ...
                          [9, 10, 11, ""],
                          [13, 14, 15, 12]])
        self.assertFalse(self.game.act_on_users_move(UsersMove.LEGAL_MOVE, "\x1b[C"))
    ...
    def test_act_on_users_move_game_exception(self):
        ...
        with self.assertRaises(IllegalMove):
            self.assertFalse(self.game.act_on_users_move(UsersMove.LEGAL_MOVE, "\x1b[D"))
    ...
    def test_evaluate_users_move_illegal_move(self):
        self.assertEquals(self.game.evaluate_users_move("\x1b[A"), UsersMove.ILLEGAL_MOVE)

    def test_evaluate_users_move_legal_move(self):
        self.assertEquals(self.game.evaluate_users_move("\x1b[B"), UsersMove.LEGAL_MOVE)
